    ...
    (function($) {
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                ...
                self.romSelect = $('<select class="selectgame"></select>').appendTo(self.romContainer);
                
                self.controls = $('<div class="nes-controls"></div>').appendTo(self.root);
                self.buttons = {
                    pause: $('<br><input type="button" value="pause" class="nes-pause nesbtn" disabled="disabled">').appendTo(self.controls),
                    restart: $('<input type="button" value="restart" class="nes-restart nesbtn" disabled="disabled">').appendTo(self.controls),
                    sound: $('<input type="button" value="enable sound" class="nes-enablesound nesbtn">').appendTo(self.controls),
                    zoom: $('<input type="button" value="zoom in" class="nes-zoom nesbtn">').appendTo(self.controls)
                };
                self.status = $('<br><p class="nes-status" id="keys">Booting up...</p>').appendTo(self.root);
            ...
            UI.prototype = {    
                ...
                */
                ...
                setRoms: function(roms) {
                    ...
                    $("<option>Please select a game</option>").appendTo(this.romSelect);
